...
class http_request_t 
{
	...
	public:
		...
		virtual void version(http_version_t v);
...
class http_head_request_t : public http_request_t
{
	private:
	protected:
	public:
		http_head_request_t(const std::string uri = "/", http_version_t version = http_version_t::HTTP_VERSION_11);
		virtual ~http_head_request_t(void) = default;
