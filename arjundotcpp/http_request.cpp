...
void 
http_request_t::version(http_version_t v)
{
	m_version = v;
	return;
}
...
http_request_t::version(void) const
{
	return m_version;
}
...
void
http_request_t::add_parameter(http_parameter_t* param)
{
...
http_head_request_t::http_head_request_t(const std::string uri, http_version_t version)
	: http_request_t(http_method_t::HTTP_METHOD_HEAD, uri, version)
{
	return;
}

std::string
http_head_request_t::to_string(void)
{
	std::string ret(this->request_line());
